        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              {t('home.hero.title', 'Connect. Drive.')} <span className="text-primary">{t('home.hero.succeed', 'Succeed.')}</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              {t('home.hero.subtitle', "India's leading platform connecting professional drivers with transport companies. Join thousands of verified drivers and companies transforming the transportation industry.")}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">{t('home.stats.drivers', 'Verified Drivers')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">2,500+</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.companies', 'Transport Companies')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">50,000+</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.trips', 'Successful Trips')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">98%</div>
                <div className="text-sm text-muted-foreground">{t('home.stats.satisfaction', 'Satisfaction Rate')}</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">Register & Verify</h4>
                    <p className="text-muted-foreground">
                      Complete your profile with documents and get verified within 24 hours.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">Browse Opportunities</h4>
                    <p className="text-muted-foreground">
                      Access thousands of job opportunities from verified transport companies.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">Connect & Drive</h4>
                    <p className="text-muted-foreground">
                      Get matched with suitable jobs and start earning with professional support.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Register your transport company and get access to verified driver network.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">Find Drivers</h4>
                    <p className="text-muted-foreground">
                      Search and connect with professional drivers based on your requirements.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">Manage Fleet</h4>
                    <p className="text-muted-foreground">
                      Use our platform to communicate, track, and manage your entire fleet efficiently.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">ABC Transport Ltd.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-semibold text-sm">Amit Patel</p>
                    <p className="text-xs text-muted-foreground">Quick Logistics</p>
                  </div>
                </div>
              </CardContent>
            </Card>
